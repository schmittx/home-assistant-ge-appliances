...
CYCLE_STATE_RAW_MAP = {
    ...
    ErdCycleStateRaw.STATE_17: ErdCycleState.INACTIVE,
    ErdCycleStateRaw.STATE_18: ErdCycleStateRaw.STATE_18,
    ErdCycleStateRaw.CYCLE_INACTIVE: ErdCycleState.INACTIVE,
    ErdCycleStateRaw.MAX: ErdCycleStateRaw.MAX,
    ErdCycleStateRaw.INVALID: ErdCycleStateRaw.INVALID,
}
